...
mixin _$WorkLog {
  ...
  Map<String, String> get series;

  Map<String, String> get load;
  ...
  $WorkLogCopyWith<WorkLog> get copyWith =>
      _$WorkLogCopyWithImpl<WorkLog>(this as WorkLog, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is WorkLog &&
...
abstract mixin class $WorkLogCopyWith<$Res> {
  factory $WorkLogCopyWith(WorkLog value,
      $Res Function(WorkLog) _then) = _$WorkLogCopyWithImpl;

  @useResult
  $Res call({
    String id, Exercise exercise, DateTime created, Map<String,
        String> series, Map<String, String> load, double bodyWeight
  });
...
class _$WorkLogCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? exercise = null, Object? created = null, Object? series = null, Object? load = null, Object? bodyWeight = null,}) {
...
extension WorkLogPatterns on WorkLog {
  ...
  TResult Function( _WorkLog value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _WorkLog extends WorkLog {
  _WorkLog(
      {required this.id, required this.exercise, required this.created, final Map<
          String,
          String> series = const <String, String>{}, final Map<String,
          String> load = const <String, String>{}, this.bodyWeight = 0.0})
      : _series = series,
        _load = load,
        super._();

  factory _WorkLog.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WorkLogCopyWith<_WorkLog> get copyWith =>
      __$WorkLogCopyWithImpl<_WorkLog>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _WorkLog &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.exercise, exercise) ||
                other.exercise == exercise) &&
            (identical(other.created, created) || other.created == created) &&
...
abstract mixin class _$WorkLogCopyWith<$Res> implements $WorkLogCopyWith<$Res> {
  factory _$WorkLogCopyWith(_WorkLog value,
      $Res Function(_WorkLog) _then) = __$WorkLogCopyWithImpl;
