...
void main() {
  ...
  testWidgets('"Today" button writes today\'s start-of-day to selectedDateProvider',
      (tester) async {
    await tester.binding.setSurfaceSize(const Size(500, 900));
    addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  testWidgets('Close button pops the dialog without changing the selected date',
      (tester) async {
    await tester.binding.setSurfaceSize(const Size(500, 900));
    addTearDown(() => tester.binding.setSurfaceSize(null));
